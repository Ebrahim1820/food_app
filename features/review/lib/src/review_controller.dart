...
class ReviewController extends GetxController {
  ReviewController(this._service, {this.onBusinessRatingChanged});

  final ReviewService _service;

  /// Called after a new review arrives over Mercure for the business
  /// currently being viewed — the business's averageRating/reviewCount live
  /// on BusinessPartnerModel, not here, so this is how the app refreshes
  /// that without ReviewController depending on BusinessPartnerController
  /// (which isn't extracted into a package yet — see initial_binding.dart).
  final void Function()? onBusinessRatingChanged;
