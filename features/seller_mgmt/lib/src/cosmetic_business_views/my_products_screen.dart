...
class MyProductsScreen extends StatelessWidget {
  ...
  /// Called from the account drawer's "switch to customer view" action —
  /// the app wires this to resetting NavigationController's shell state and
  /// navigating to the Dashboard, since this package owns no shell/nav state.
  final VoidCallback onSwitchToCustomerView;

  /// Called from the overflow menu's "Settings" item — app-shell navigation.
  final VoidCallback onOpenSettings;

  /// Built by the caller (usually `const LogoutWidget()`) and forwarded to
  /// AppDrawer's `footer` — this package can't depend on the app's
  /// session/logout wiring.
