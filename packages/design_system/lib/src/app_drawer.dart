...
class AppDrawer extends StatelessWidget {
  ...
  /// Built by the caller (usually `const LogoutWidget()`) — kept
  /// caller-supplied, like [avatarWidget], so this widget doesn't have to
  /// depend on the app's session/logout wiring.
  final Widget footer;
...
class _DrawerFooter extends StatelessWidget {
  const _DrawerFooter({required this.footer});
